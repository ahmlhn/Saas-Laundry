...
Route::middleware(['auth:sanctum', 'outlet.access'])->group(function (): void {
    ...
    Route::get('/payment-gateway/settings', [PaymentGatewayController::class, 'showSettings']);
    Route::put('/payment-gateway/settings', [PaymentGatewayController::class, 'upsertSettings']);
    Route::get('/payment-gateway/qris-transactions', [PaymentGatewayController::class, 'qrisTransactions']);
...
Route::middleware(['auth:sanctum'])->group(function (): void {
    ...
    Route::post('/devices/push-token', [DevicePushTokenController::class, 'upsert']);

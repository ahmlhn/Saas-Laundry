...
<section class="panel-section">
    ...
    <form method="GET" class="filters-grid">
        ...
        <div class="filter-actions">
            ...
            <a class="btn btn-ghost" href="{{ route('tenant.shipping-zones.index') }}">Atur Ulang</a>
        </div>
    </form>
</section>
...
<section class="panel-section">
    ...
    <form method="POST" action="{{ route('tenant.shipping-zones.store') }}" class="filters-grid">
        @csrf
        <div>
        ...
        <table>
            ...
            @forelse($rows as $zone)
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{ route('tenant.shipping-zones.update', ['zone' => $zone->id]) }}" class="filters-grid" style="grid-template-columns: repeat(3, minmax(0, 1fr));">
                            @csrf
                            <div>
                                <label>Nama</label>
        ...
        <table>
            ...
            @forelse($activeRows as $zone)
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{ route('tenant.shipping-zones.deactivate', ['zone' => $zone->id]) }}" class="inline-form">
                            @csrf
        ...
        <table>
            ...
            @forelse($inactiveRows as $zone)
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{ route('tenant.shipping-zones.activate', ['zone' => $zone->id]) }}" class="inline-form">
                            @csrf

        ...
        <table>
            ...
            @forelse($rows as $row)
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{ route('tenant.services.archive', ['service' => $row->id]) }}" class="inline-form">
                            @csrf
        ...
        <table>
            ...
            @forelse($archivedRows as $row)
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{ route('tenant.services.restore', ['service' => $row->id]) }}" class="inline-form">
                            @csrf

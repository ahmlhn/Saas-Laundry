...
<section class="panel-section">
    ...
    <form method="GET" class="filters-grid">
        ...
        <div class="filter-actions">
            ...
            <a class="btn btn-ghost" href="{{ route('tenant.outlet-services.index') }}">Atur Ulang</a>
        </div>
    </form>
</section>
...
<section class="panel-section">
    ...
    <form method="POST" action="{{ route('tenant.outlet-services.upsert') }}" class="filters-grid">
        @csrf
        <div>
        ...
        <table>
            ...
            @forelse($rows as $row)
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{ route('tenant.outlet-services.update', ['outletService' => $row->id]) }}" class="filters-grid" style="grid-template-columns: repeat(4, minmax(0, 1fr));">
                            @csrf
                            <div>
                                <label>Status</label>
                                <select name="active">

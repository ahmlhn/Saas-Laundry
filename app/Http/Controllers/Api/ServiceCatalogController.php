...
class ServiceCatalogController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'active' => ['nullable', 'boolean'],
            'show_in_cashier' => ['nullable', 'boolean'],
        ...
        $service = Service::query()->create([
            ...
            'show_in_cashier' => (bool) ($validated['show_in_cashier'] ?? true),
            'show_to_customer' => (bool) ($validated['show_to_customer'] ?? true),
    ...
    public function update(Request $request, Service $service): JsonResponse
    {
        ...
        $changes = [
            ...
            'show_in_cashier' => array_key_exists('show_in_cashier', $validated) ? (bool) $validated['show_in_cashier'] : (bool) $service->show_in_cashier,
            'show_to_customer' => array_key_exists('show_to_customer', $validated) ? (bool) $validated['show_to_customer'] : (bool) $service->show_to_customer,
    ...
    private function serializeService(
        ...
        $payload = [
            ...
            'show_in_cashier' => (bool) $service->show_in_cashier,
            'show_to_customer' => (bool) $service->show_to_customer,
